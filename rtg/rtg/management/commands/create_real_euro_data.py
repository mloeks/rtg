...
from rtg.models import TournamentGroup, TournamentRound, Venue, Team, Game
...
class Command(BaseCommand):
    ...
    def clear_data(self):
        ...
        # Run.objects.filter(runner__user__username=self.USERNAME).delete()
    ...
    def create_first_round_games(self):
        self.create_game_helper('FRA', 'ROU', '2016-06-10 21:00:00+02', 'saint-denis')
        self.create_game_helper('ALB', 'SUI', '2016-06-11 15:00:00+02', 'lens')
        self.create_game_helper('WAL', 'SVK', '2016-06-11 18:00:00+02', 'bordeaux')
        self.create_game_helper('ENG', 'RUS', '2016-06-11 21:00:00+02', 'marseille')
        self.create_game_helper('TUR', 'CRO', '2016-06-12 15:00:00+02', 'paris')
        self.create_game_helper('POL', 'NIR', '2016-06-12 18:00:00+02', 'nizza')
        self.create_game_helper('GER', 'UKR', '2016-06-12 21:00:00+02', 'lille')
        self.create_game_helper('ESP', 'CZE', '2016-06-13 15:00:00+02', 'toulouse')
        self.create_game_helper('IRL', 'SWE', '2016-06-13 18:00:00+02', 'saint-denis')
        self.create_game_helper('BEL', 'ITA', '2016-06-13 21:00:00+02', 'lyon')
        self.create_game_helper('AUT', 'HUN', '2016-06-14 18:00:00+02', 'bordeaux')
        self.create_game_helper('POR', 'ISL', '2016-06-14 21:00:00+02', 'saint-etienne')

        self.create_game_helper('RUS', 'SVK', '2016-06-15 15:00:00+02', 'lille')
        self.create_game_helper('ROU', 'SUI', '2016-06-15 18:00:00+02', 'paris')
        self.create_game_helper('FRA', 'ALB', '2016-06-15 21:00:00+02', 'marseille')
        self.create_game_helper('ENG', 'WAL', '2016-06-16 15:00:00+02', 'lens')
        self.create_game_helper('UKR', 'NIR', '2016-06-16 18:00:00+02', 'lyon')
        self.create_game_helper('GER', 'POL', '2016-06-16 21:00:00+02', 'saint-denis')
        self.create_game_helper('ITA', 'SWE', '2016-06-17 15:00:00+02', 'toulouse')
        self.create_game_helper('CZE', 'CRO', '2016-06-17 18:00:00+02', 'saint-etienne')
        self.create_game_helper('ESP', 'TUR', '2016-06-17 21:00:00+02', 'nizza')
        self.create_game_helper('BEL', 'IRL', '2016-06-18 15:00:00+02', 'bordeaux')
        self.create_game_helper('ISL', 'HUN', '2016-06-18 18:00:00+02', 'marseille')
        self.create_game_helper('POR', 'AUT', '2016-06-18 21:00:00+02', 'paris')

        self.create_game_helper('ROU', 'ALB', '2016-06-19 21:00:00+02', 'lyon')
        self.create_game_helper('SUI', 'FRA', '2016-06-19 21:00:00+02', 'lille')
        self.create_game_helper('RUS', 'WAL', '2016-06-20 21:00:00+02', 'toulouse')
        self.create_game_helper('SVK', 'ENG', '2016-06-20 21:00:00+02', 'saint-etienne')
        self.create_game_helper('UKR', 'POL', '2016-06-21 18:00:00+02', 'marseille')
        self.create_game_helper('NIR', 'GER', '2016-06-21 18:00:00+02', 'paris')
        self.create_game_helper('CZE', 'TUR', '2016-06-21 21:00:00+02', 'lens')
        self.create_game_helper('CRO', 'ESP', '2016-06-21 21:00:00+02', 'bordeaux')
        self.create_game_helper('ISL', 'AUT', '2016-06-22 18:00:00+02', 'saint-denis')
        self.create_game_helper('HUN', 'POR', '2016-06-22 18:00:00+02', 'lyon')
        self.create_game_helper('ITA', 'IRL', '2016-06-22 21:00:00+02', 'lille')
