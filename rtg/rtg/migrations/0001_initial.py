    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra', models.ForeignKey(to='rtg.Extra')),
            ],
        ),
        migrations.CreateModel(
            name='ExtraChoice',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(to='rtg.Game')),
            ],
        ),
        migrations.CreateModel(
            name='GameBetResult',
        ...
        migrations.CreateModel(
            name='Profile',
            fields=[
                ('avatar', models.ImageField(storage=rtg.storage.OverwriteStorage(), null=True, upload_to=rtg.utils.get_avatar_path, blank=True)),
                ('avatar_cropped', models.ImageField(storage=rtg.storage.OverwriteStorage(), null=True, upload_to=rtg.utils.get_thumb_path, blank=True)),
        ...
        migrations.AddField(
            model_name='team',
            name='group',
            field=models.ForeignKey(to='rtg.TournamentGroup'),
        ),
        migrations.AddField(
            model_name='post',
            name='author',
        ...
        migrations.AddField(
            model_name='post',
            name='parent_post',
            field=models.ForeignKey(related_name='child_posts', blank=True, to='rtg.Post', null=True),
        ),
        migrations.AddField(
            model_name='post',
            name='target_user',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(verbose_name=b'Result Type', blank=True, to='rtg.GameBetResult', null=True),
        ),
        migrations.AddField(
            model_name='gamebet',
            name='user',
        ...
        migrations.AddField(
            model_name='game',
            name='awayteam',
            field=models.ForeignKey(related_name='games_away', to='rtg.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='hometeam',
            field=models.ForeignKey(related_name='games_home', to='rtg.Team'),
        ),
        migrations.AddField(
            model_name='game',
            name='round',
            field=models.ForeignKey(to='rtg.TournamentRound'),
        ),
        migrations.AddField(
            model_name='game',
            name='venue',
            field=models.ForeignKey(to='rtg.Venue'),
        ),
        migrations.AddField(
            model_name='extrabet',
            name='user',
        ...
        migrations.AddField(
            model_name='extra',
            name='game_yield',
            field=models.ForeignKey(blank=True, to='rtg.Game', null=True),
        ),
